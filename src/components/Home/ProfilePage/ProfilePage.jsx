                                ...
                                <form className="w-full bg-transparent shadow-lg rounded px-8 pt-6 pb-8 mb-4">
                                    <div className="mb-4">
                                        <label className="block text-white text-xl font-bold mb-2 lg:w-[500px] md:w-1/2" htmlFor="name">
                                            {mySubscription.type === "Org" ? "Organization Name" : "Package Name"}
                                        </label>
                                        <h2 className='text-white text-lg font-sans'>
                                            {
                                                mySubscription.type === "Org" ? mySubscription.org.name : mySubscription.type
                                            }
                                        </h2>
                                        <h2 className='text-white text-lg font-sans'>
                                            {
                                                mySubscription.type === "Org" ? mySubscription.org.email : ""
                                            }
                                        </h2>
                                    </div>
                                    <div className="mb-4">
                                        ...
                                        {
                                            mySubscription.type && mySubscription.type !== "Org" && (
                                                (mySubscription.type === "Inner Circle" || mySubscription.type === "Basic" || mySubscription.type === "Girls L.E.A.P. Inner Circle") ? (
